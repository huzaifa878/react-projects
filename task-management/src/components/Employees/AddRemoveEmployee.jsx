            ...
            <div className='fixed z-1 bg-black/50 top-0 left-0 w-full h-full flex items-center justify-center gap-10'>
                <div className="h-[90vh] w-[35%] max-w-2xl bg-[#05131f] rounded-lg shadow-lg p-6">
                    ...
                    <div className='h-[87vh] overflow-y-auto placeholder:text-blue-300 hidden'>
                        ...
                        <input type="email" className='text-yellow-500 w-full focus:outline-none focus:ring-0 border-b border-b-1 border-b-blue-300 mb-3 pb-1 mb-5' />

                        <h2 className='text-blue-300'>Password</h2>
                        <input type="password" className='text-yellow-500 w-full focus:outline-none focus:ring-0 border-b border-b-1 border-b-blue-300 mb-3 pb-1 mb-5' />
